...
<a id="item3-q4"></a>
#### Q4 次の `TextBlock` に `operator[]` を追加することを考える。
...
<a id="item3-q5"></a>
#### Q5 外から見て不変を保ちながら、内部キャッシュだけ更新するには？
...
<a id="item3-q6"></a>
#### Q6 同じロジックを2回書かずに、どちらを本体にすべきですか？
...
<a id="item3-q10"></a>
#### Q10 `const_iterator` は何が `const` ですか？
